			...
			<div id="participantdiv">
				...
				<div v-if="participant?.participant_id != loginStatusStore.loggedInStatus?.userID">
					...
					<div v-if="userIsAdmin || userIsOwner">
						...
						<SmallButton v-if="participant.participant_is_muted < new Date(Date.now()).toISOString() " class="button" text="Mute this user" @click="muteUser(participant.participant_id)"/>
