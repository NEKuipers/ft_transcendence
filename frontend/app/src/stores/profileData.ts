...
export const loginStatusStore = defineStore ('login', {
	state: () => ({
		...
		loggedInStatus: new LoginData(1, "nkuipers", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyaWQiOjMsInVzZXJuYW1lIjoibmt1aXBlcnMifQ.h3HAJiIKBKXJgx8f3fOKVl7ssz0BLMwfx0eD_BjmJzs") as undefined | LoginData
	}),
	getters: {},
	actions: {
